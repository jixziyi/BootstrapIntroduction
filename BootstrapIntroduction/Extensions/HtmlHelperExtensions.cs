...
namespace BootstrapIntroduction.Extensions
{
    public static class HtmlHelperExtensions
    {
        ...
        public static HtmlString BuildSortableLink(this HtmlHelper htmlHelper, string fieldName, string actionName, string sortField, QueryOptions queryOptions)
        {
            ...
            this HtmlHelper htmlHelper, string actionName)
        {
            ...
            return new MvcHtmlString(string.Format(
                ...
                "   <a herf=\"{0}\" data-bind=\"click:pagingService.previousPage\">Previous</a></li>" + 
